...
void Lvgl_Example1(void){
  ...
  lv_obj_t *temp_objects[] = {SD_Size, FlashSize, BAT_Volts, Backlight_subtract, Backlight_add};
...
static void Onboard_create(lv_obj_t * parent)
{
  ...
  lv_obj_set_grid_cell(Backlight_subtract, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER, 9, 1);
  lv_obj_set_grid_cell(Backlight_slider, LV_GRID_ALIGN_STRETCH, 2, 1, LV_GRID_ALIGN_CENTER, 9, 1);
  lv_obj_set_grid_cell(Backlight_add, LV_GRID_ALIGN_CENTER, 4, 1, LV_GRID_ALIGN_CENTER, 9, 1);
